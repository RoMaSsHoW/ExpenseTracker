...
public class GetAllTransactionsQueryHandler : IQueryHandler<GetAllTransactionsQuery, PaginatedTransactionsDTO>
{
    ...
    public async Task<PaginatedTransactionsDTO> Handle(GetAllTransactionsQuery request, CancellationToken cancellationToken)
    {
